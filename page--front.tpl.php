...
<div id="page" class="container-16 clearfix">
	...
	<div id="mainarea" class="container-16 clearfix">	
		<div id="sitecontent" class="grid-16">
			<div id="slide-show" class="column grid-16">
                  <?php print render($page['slide_show']); ?>
             </div>
             <div id="about" class="column grid-9">
                  <?php print render($page['about']); ?>
             </div>
             <div id="recent" class="column grid-6">
		<div id="featured">
		  <?php print render($page['recent']); ?>
		</div>
		<div id="recent_titles">
                  <?php print $variables['recent_titles']; ?>
		</div>
             </div>		
		</div>
	</div>
